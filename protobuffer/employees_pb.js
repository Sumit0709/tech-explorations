...
goog.exportSymbol('proto.EmployeeList', null, global);
/**
 ...
 * @constructor
 */
proto.EmployeeList = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.EmployeeList.repeatedFields_, null);
};
goog.inherits(proto.EmployeeList, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.EmployeeList.displayName = 'proto.EmployeeList';
}
...
proto.Employee.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    joiningDate: jspb.Message.getFieldWithDefault(msg, 3, ""),
...
/**
 * optional string joining_date = 3;
 * @return {string}
 */
proto.Employee.prototype.getJoiningDate = function() {
 ...
 * @return {!proto.Employee} returns this
 */
proto.Employee.prototype.setJoiningDate = function(value) {
 ...
 * @const
 */
proto.EmployeeList.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.EmployeeList.prototype.toObject = function(opt_includeInstance) {
  return proto.EmployeeList.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.EmployeeList} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.EmployeeList.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.EmployeeList}
 */
proto.EmployeeList.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.EmployeeList;
  return proto.EmployeeList.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.EmployeeList} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.EmployeeList}
 */
proto.EmployeeList.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.EmployeeList.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.EmployeeList.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.EmployeeList} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.EmployeeList.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 */
proto.EmployeeList.prototype.getEmployeesList = function() {
 ...
 * @return {!proto.EmployeeList} returns this
*/
proto.EmployeeList.prototype.setEmployeesList = function(value) {
 ...
 * @return {!proto.Employee}
 */
proto.EmployeeList.prototype.addEmployees = function(opt_value, opt_index) {
 ...
 * @return {!proto.EmployeeList} returns this
 */
proto.EmployeeList.prototype.clearEmployeesList = function() {
